    ...
    <aside class="sidebar" id="sidebar">
        ...
        <div class="sidebar-user">
            <div class="user-avatar">
                {{ strtoupper(substr(Auth::user()->guest->first_name ?? 'G', 0, 1)) }}
            </div>
            <div class="user-name">
        ...
        <header class="topbar">
            ...
            <div class="topbar-right">
                <span class="topbar-greeting">
                    Welcome back, <span>{{ Auth::user()->guest->first_name ?? 'Guest' }}</span>
                </span>
            ...
            <div class="stats-grid">
                <div class="stat-card">
                    ...
                    <div class="stat-value">
                        {{ Auth::user()->guest->reservations()->count() ?? 0 }}
                    </div>
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-value">
                        {{ Auth::user()->guest->reservations()->where('status', 'checked_in')->count() ?? 0 }}
                    </div>
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-value">
                        {{ Auth::user()->guest->invoices()->where('status', 'pending')->count() ?? 0 }}
                    </div>
